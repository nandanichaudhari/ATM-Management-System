...
public class MiniStatement extends javax.swing.JFrame {
    ...
    {
        list=service.transaction(person.getAccountNo());
        if(list!=null)
        {
            DefaultTableModel tmodel=(DefaultTableModel)ta1.getModel();
            for(Transaction item : list)
            {
                Object data[]={item.getTID(),item.getDate(),item.getAmount(),item.getType()};
                tmodel.addRow(data);
            }
            ta1.setModel(tmodel);
        }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       TransactionOption TO=new TransactionOption();
       TO.setVisible(true);
        TO.loggedInUser(person);
       this.dispose();
